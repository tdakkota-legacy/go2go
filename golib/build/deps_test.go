...
var pkgDeps = map[string][]string{
	...
	"github.com/tdakkota/go2go/testutil/testenv": {"L2", "OS", "flag", "testing", "syscall", "internal/cfg"},
	...
	// Go parser.
	"github.com/tdakkota/go2go/golib/ast":     {"L4", "OS", "go/scanner", "go/token"},
	"github.com/tdakkota/go2go/golib/doc":     {"L4", "OS", "go/ast", "go/token", "regexp", "internal/lazyregexp", "text/template"},
	"github.com/tdakkota/go2go/golib/parser":  {"L4", "OS", "go/ast", "go/scanner", "go/token"},
	"github.com/tdakkota/go2go/golib/printer": {"L4", "OS", "go/ast", "go/scanner", "go/token", "text/tabwriter"},
	"github.com/tdakkota/go2go/golib/scanner": {"L4", "OS", "go/token"},
	"github.com/tdakkota/go2go/golib/token":   {"L4"},
	...
	"github.com/tdakkota/go2go/golib/format": {"L4", "GOPARSER", "internal/format"},
	"internal/format":                        {"L4", "GOPARSER"},

	// Go type checking.
	"github.com/tdakkota/go2go/golib/constant":               {"L4", "go/token", "math/big"},
	"github.com/tdakkota/go2go/golib/importer":               {"L4", "go/build", "go/internal/gccgoimporter", "go/internal/gcimporter", "go/internal/srcimporter", "go/token", "go/types"},
	"github.com/tdakkota/go2go/golib/internal/gcimporter":    {"L4", "OS", "go/build", "go/constant", "go/token", "go/types", "text/scanner"},
	"github.com/tdakkota/go2go/golib/internal/gccgoimporter": {"L4", "OS", "debug/elf", "go/constant", "go/token", "go/types", "internal/xcoff", "text/scanner"},
	"github.com/tdakkota/go2go/golib/internal/srcimporter":   {"L4", "OS", "fmt", "go/ast", "go/build", "go/parser", "go/token", "go/types", "path/filepath"},
	"github.com/tdakkota/go2go/golib/types":                  {"L4", "GOPARSER", "container/heap", "go/constant"},
	"github.com/tdakkota/go2go/golib/go2go":                  {"L4", "GOPARSER", "OS", "go/build", "go/importer", "go/types", "internal/goroot"},
	...
	"flag":                                  {"L4", "OS"},
	"github.com/tdakkota/go2go/golib/build": {"L4", "OS", "GOPARSER", "internal/goroot", "internal/goversion"},
	"html":                                  {"L4"},
